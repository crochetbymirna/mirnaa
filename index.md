<head>
    ...
    <style>
        ...
        .product-grid {
            ...
            max-width: 100%; /* Allow the grid to take up full width */
            padding: 20px 0;
            margin-left: 45px;
            margin-right: 45px;
        }
        ...
        .product-item {
            ...
            background: white;
            border-radius: 10px;
            box-shadow: 0px 0px 20px 6px rgb(255 170 170 / 10%);
            /* padding: 15px; */
        ...
        .product-item:hover {
            ...
            box-shadow: 0px 0px 20px 12px rgb(255 170 170 / 10%);
        }
        ...
        .why-choose-us {
            padding: 1px 20px;
            /* background: linear-gradient(to bottom, #fff1f4 0px, #fdadbe 50%, #fff1f4 300px); */
            background: rgb(255 181 187 / 90%);
            text-align: center;
        }
        ...
        .gradient-top {
            ...
            background: linear-gradient(to bottom, rgb(255 209 219 / 90%), rgb(255 181 187 / 90%)); /* Top fades from the previous section's color to transparent */
        }

        .gradient-bottom {
            height: 50px; /* Adjust height as needed */
            background: linear-gradient(to top, rgb(255 209 219 / 90%), rgb(255 181 187 / 90%)); /* Bottom fades from the next section's color to transparent */
        }
...
<body>
    ...
    <header>
        ...
        <div class="center-content">
            ...
            <h2>Crafted with passion, stitched with care – our handmade crochet bags bring beauty, durability, and elegance to your everyday life. Embrace the art of timeless design.</h2>
    ...
    <section class="products-section" id="products">
        ...
        <!-- Scroll buttons -->
        <button class="scroll-button left" onclick="scrollLeftContainer()">&#8592;</button>
        <button class="scroll-button right" onclick="scrollRight()">&#8594;</button>
        <!-- Scrollable grid -->
        <div class="product-grid">
            <div class="product-item">
                <img src="https://i.imgur.com/rBH5RP9.jpg" alt="Bag 6">
                <p>"Versatile and trendy crochet bag, designed for both comfort and style."</p>
            </div>
            <div class="product-item">
                <img src="https://i.imgur.com/sgaUfsL.jpg" alt="Bag 7">
            ...
            <div class="product-item">
                ...
                <p>"Handcrafted crochet bag with timeless elegance and charm."</p>
            </div>
        </div>
        <a href="bag1.html" class="shop-now">Shop Now</a>
    </section>
